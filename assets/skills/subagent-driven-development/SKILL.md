...
description: Use when PiStack has confirmed subagent-driven execution mode and dispatches you with clusters of independent tasks
---

# Subagent-Driven Development

**Prerequisite:** This skill runs AFTER the coordinator (PiStack) has:
...
**vs. Manual execution (same session):**
...
**Follow Core Instructions** — `AGENTS.md` Core Instructions section for CodeGraph usage patterns. Do NOT duplicate those instructions here.
...
- **Use `Bash` with `rg`/`grep` for code search** — follow Core Instructions in `AGENTS.md`
...
- Execute tasks directly if parallel session is not needed
