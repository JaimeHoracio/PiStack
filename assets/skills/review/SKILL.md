...
1. **Follow Core Instructions** — `AGENTS.md` Core Instructions section for CodeGraph usage patterns. Use `codegraph_explore` to understand the code structure before reading files directly.
...
1. **FOLLOW CORE INSTRUCTIONS** — Use CodeGraph for code understanding before reading files. See `AGENTS.md` Core Instructions section.
