...
PiStack (the coordinator) handles execution-mode analysis and user confirmation after the plan is ready. This skill only writes the plan — it does NOT offer the user an execution mode choice. If an execution-mode prompt appears, defer to the coordinator.
